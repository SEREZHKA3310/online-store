...
def _triple_main(filename: str) -> list[str]: 
    p = _m(filename) 
    return [p, p, p] 
    ...
    def handle(self, *args, **kwargs): 
        ...
        products = [ 
            { 
                ...
                "images": _triple_main("Asymmetric Dress.png"), 
            ...
            { 
                ...
                "images": _triple_main("Bold Geometric Top.png"), 
            ...
            { 
                ...
                "images": _triple_main("Bold_Geometric_Top.png"), 
            ...
            { 
                ...
                "description": ["Куртка с деконструированным кроем, на сезон весна–осень."], 
                "images": _triple_main("Deconstructed_Jacket.png"), 
            ...
            { 
                ...
                "description": ["Двойная вязка, лаконичный силуэт, подходит к пальто и пуховику."], 
                "images": [ 
                    _m("Minimalist_Hat.png"), 
                    _m("Minimalist_Hat_2.png"),
                    _m("Minimalist_Hat_3.png"), 
                ], 
            ...
            { 
                ...
                "description": ["Кроссовки на шнуровке, неоновые вставки, амортизирующая подошва."], 
                "images": _triple_main("Neon_Accent_Sneakers.png"), 
            ...
            { 
                ...
                "description": ["Лёгкая городская модель, сетка верха, контрастная подошва."], 
                "images": _triple_main("Neon_Accen_Sneakers.png"), 
            ...
            { 
                ...
                "main_image": _m("Bold Geometric Top.png"), 
                "description": ["Широкие джинсы с высокой посадкой и barrel-ногой, плотный деним."],
                "images": _triple_main("Bold Geometric Top.png"), 
            ...
            { 
                ...
                "main_image": _m("Bold_Geometric_Top.png"), 
                "description": ["Прямые палаццо из плотного трикотажа, комфортный эластичный пояс."],
                "images": _triple_main("Bold_Geometric_Top.png"), 
